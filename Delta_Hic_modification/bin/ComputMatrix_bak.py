...
class subMatrix():
	...
	def colorbar(self,ax,im,type):
		...
		if type=='trimap':
			...
			cbar=plt.colorbar(im, cax=axins1, orientation='vertical',ticks=[round(self.vmin),round(self.vmax)])
		else:
			...
			cbar=plt.colorbar(im, cax=axins1, orientation='vertical',ticks=[round(self.up),round(self.down)])
		return cbar
